 ...
 */
var RecordAlreadyExists = /** @class */ (function (_super) {
    __extends(RecordAlreadyExists, _super);
    function RecordAlreadyExists() {
        return _super.call(this, '500002', 'Record already exist.') || this;
    }
    return RecordAlreadyExists;
}(DocumentTracerError_js_1.default));
exports.default = RecordAlreadyExists;
